...
import broadcastMessage from "app/core/mutations/broadcast-all"
import { useState } from "react"
import { validateZodSchema } from "blitz"
import getAdminInfo from "app/core/queries/getAdminInfo"

const BroadcastAll: BlitzPage = () => {
      ...
      <main className="my-8 bg-white dark:bg-gray-900 lg:relative">
        <div>
          ...
          <p className="mx-auto my-8 text-center text-xl">
            This must not be used lightly and without sign-off. Only use this for legally required
            communications.
          </p>
