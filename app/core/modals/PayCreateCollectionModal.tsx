    ...
    <>
      ...
      >
        <div className="border-gradient-to-r relative overflow-hidden rounded-md from-indigo-500 px-9 py-5">
          <p className="relative z-10">Pay and create</p>
        </div>
      </button>
                  ...
                  >
                    <div className="mt-2">
                      <p className="text-base text-gray-500 dark:text-gray-300">
                        Once you create this collection, you cannot delete it. Because you chose a{" "}
                        {type.toLowerCase()} collection, creating it costs {price} (incl. VAT).
                      </p>
                    </div>
