  ...
  return (
    <div className="bg-white py-24 dark:bg-gray-900 sm:py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-12 py-8 dark:invert sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 sm:gap-y-14 lg:mx-0 lg:max-w-none lg:grid-cols-5 ">
          <img
